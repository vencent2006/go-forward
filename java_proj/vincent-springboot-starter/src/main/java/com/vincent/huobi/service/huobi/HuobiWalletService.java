...
import com.vincent.huobi.client.WalletClient;
import com.vincent.huobi.client.req.wallet.*;
...
import com.vincent.huobi.constant.enums.DepositWithdrawTypeEnum;
import com.vincent.huobi.model.market.MarketDetailMerged;
import com.vincent.huobi.model.wallet.*;
...
import com.vincent.huobi.service.huobi.parser.wallet.DepositWithdrawParser;
import com.vincent.huobi.service.huobi.parser.wallet.WithdrawAddressParser;
import com.vincent.huobi.service.huobi.parser.wallet.WithdrawQuotaParser;
...
public class HuobiWalletService implements WalletClient {
  ...
  public static final String QUERY_WITHDRAW_PATH = "/v1/query/withdraw/client-order-id";
  ...
  // @Override
  public WithdrawByClientOrderId getWithdrawByClientOrderId(WithdrawByClientOrderIdRequest request) {
    ...
    UrlParamsBuilder builder = UrlParamsBuilder.build()
            .putToUrl("clientOrderId", request.getClientOrderId());

    JSONObject jsonObject = restConnection.executeGetWithSignature(QUERY_WITHDRAW_PATH, builder);
    JSONObject data = jsonObject.getJSONObject("data");
    if (null == data){
        return null;
    } else {
        return data.toJavaObject(WithdrawByClientOrderId.class);
    }
  }

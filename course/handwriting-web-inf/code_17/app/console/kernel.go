...
import (
	"go-examples/course/handwriting-web-inf/code_17/app/console/command/demo"
	"go-examples/course/handwriting-web-inf/code_17/framework"
	"go-examples/course/handwriting-web-inf/code_17/framework/cobra"
	"go-examples/course/handwriting-web-inf/code_17/framework/command"
)

...
import (
	...
	"go-examples/course/handwriting-web-inf/code_17/framework/gin/binding"

	"github.com/gin-contrib/sse"
	"github.com/golang/protobuf/proto"
	"github.com/stretchr/testify/assert"

	testdata "go-examples/course/handwriting-web-inf/code_17/framework/gin/testdata/protoexample"
)
...
func TestContextHandlerName(t *testing.T) {
	...
	assert.Regexp(t, "^(.*/vendor/)?go-examples/course/handwriting-web-inf/code_17/framework/gin.handlerNameTest$", c.HandlerName())
}
...
func TestContextHandlerNames(t *testing.T) {
	...
	for _, name := range names {
		assert.Regexp(t, `^(.*/vendor/)?(go-examples/course/handwriting-web-inf/code_17/framework/gin\.){1}(TestContextHandlerNames\.func.*){0,1}(handlerNameTest.*){0,1}`, name)
	}
}

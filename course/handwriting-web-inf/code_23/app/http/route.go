...
import (
	...
	ginSwagger "go-examples/course/handwriting-web-inf/code_23/framework/middleware/gin-swagger"
	"go-examples/course/handwriting-web-inf/code_23/framework/middleware/gin-swagger/swaggerFiles"

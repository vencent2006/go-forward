...
import (
	"go-examples/course/handwriting-web-inf/code_18/app/console/command/demo"
	"go-examples/course/handwriting-web-inf/code_18/framework"
	"go-examples/course/handwriting-web-inf/code_18/framework/cobra"
	"go-examples/course/handwriting-web-inf/code_18/framework/command"
)

...
func TestDebugPrintRoutes(t *testing.T) {
	...
	assert.Regexp(t, `^\[GIN-debug\] GET    /path/to/route/:param     --> (.*/vendor/)?go-examples/course/handwriting-web-inf/code_18/framework/gin.handlerNameTest \(2 handlers\)\n$`, re)
}
...
func TestDebugPrintRouteFunc(t *testing.T) {
	...
	assert.Regexp(t, `^\[GIN-debug\] GET    /path/to/route/:param1/:param2           --> (.*/vendor/)?go-examples/course/handwriting-web-inf/code_18/framework/gin.handlerNameTest \(2 handlers\)\n$`, re)
}

...
type IRequest interface {
	...
	QueryStringSlice(key string, def []string) ([]string, bool) //foo.com?c[]=bar
	...
	FormFile(key string) (*multipart.FileHeader, error) // 文件吗？
...
func (ctx *Context) ClientIp() string {
	r := ctx.request
	//todo:X-Real-Ip 和 X-Forwarded-For，这个拼写得校验下

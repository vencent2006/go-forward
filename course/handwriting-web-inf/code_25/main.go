...
import (
	"go-examples/course/handwriting-web-inf/code_25/app/console"
	"go-examples/course/handwriting-web-inf/code_25/app/http"
	"go-examples/course/handwriting-web-inf/code_25/framework"
	"go-examples/course/handwriting-web-inf/code_25/framework/provider/app"
	"go-examples/course/handwriting-web-inf/code_25/framework/provider/config"
	"go-examples/course/handwriting-web-inf/code_25/framework/provider/distributed"

...
// Remember 缓存的Remember方法使用，Cache-Aside模式对应的对象生成方法
...
type CacheService interface {
	...
	// GetObj 获取某个key对应的对象，对象必须实现序列化接口 https://pkg.go.dev/encoding#BinaryUnMarshaler
	...
	// SetObj 设置某个key和对象到缓存，对象必须实现序列化接口 https://pkg.go.dev/encoding#BinaryMarshaler
	...
	// SetForeverObj 设置某个key和对象缓存，不带超时时间，对象必须实现 https://pkg.go.dev/encoding#BinaryMarshaler
